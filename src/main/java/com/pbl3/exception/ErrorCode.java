...
public enum ErrorCode {
    ...
    TEAM_NOT_READY_TO_COMPLETE(4007, "Chưa thể hoàn thành nhóm vì vẫn còn công việc chưa DONE hoặc nhóm chưa có task", HttpStatus.BAD_REQUEST),
    PROJECT_NOT_READY_TO_COMPLETE(4008, "Chưa thể hoàn thành dự án vì vẫn còn công việc chưa DONE hoặc dự án chưa có task", HttpStatus.BAD_REQUEST),
