...
public class MainLayout extends AppLayout {
    ...
    private void createHeader() {
        ...
        String currentUsername = authContext.getPrincipalName().orElse("User");
        Span welcomeText = new Span("Chào mừng quay trở lại, " + currentUsername);
        ...
        HorizontalLayout header = new HorizontalLayout(new DrawerToggle(), logo, welcomeText, logout);
        header.setDefaultVerticalComponentAlignment(FlexComponent.Alignment.CENTER);
        header.expand(logo); // Đẩy lời chào và nút logout sang bên phải
        header.setWidthFull();
