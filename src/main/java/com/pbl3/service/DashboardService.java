...
public class DashboardService {
    ...
    private void buildProjectManagerDashboard(DashboardResponse.DashboardResponseBuilder builder, Long pmId) {
        // Lay truc tiep cac project do PM quan ly, khong can lay availableProjects roi filter trong Java.
        List<Project> managedProjects = projectRepository.findByManagerId(pmId);
